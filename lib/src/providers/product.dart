...
class ProductProvider with ChangeNotifier {
  ...
  List<ProductModel> productsByFoodType = [];
  ...
  Future loadProductsByFoodType({String foodType}) async {
    productsByFoodType =
        await _productServices.getProductsFromFoodType(foodType: foodType);
    notifyListeners();
  }
